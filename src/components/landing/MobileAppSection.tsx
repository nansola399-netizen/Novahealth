        ...
        <section className="relative py-32 bg-slate-900 overflow-hidden text-white">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 bg-blue-500/10 text-blue-300 px-4 py-2 rounded-full mb-8 border border-blue-500/20">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight leading-tight">
                            Healthcare at <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-teal-400">Your Fingertips</span>
                        </h2>
                        ...
                        <div className="mt-8 flex items-center gap-4">
                            <Button variant="link" className="text-blue-400 p-0 h-auto font-medium hover:text-blue-300">
